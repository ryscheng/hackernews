...
(def nsv ((o port 8080) (o subdir "default"))
  (pr (+ "FS partition: " subdir))
  (= newsdir*  (+ "arc/news/" subdir "/")
    storydir* (+ "arc/news/" subdir "/story/")
    profdir*  (+ "arc/news/" subdir "/profile/")
    votedir*  (+ "arc/news/" subdir "/vote/"))
